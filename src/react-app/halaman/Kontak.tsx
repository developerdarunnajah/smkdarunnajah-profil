    ...
    <section className="section">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "40px" }}>
        <div>
          ...
          <p style={{ marginBottom: "12px" }}><strong>WA:</strong> </p>
          <p style={{ marginBottom: "12px" }}><strong>E-Mail:</strong> smkdanalmj@gmail.com</p>
          <p style={{ marginBottom: "12px" }}><strong>Pelayanan:</strong> Sabtu s.d. Kamis (Pukul 07.00 - 13.00 WIB)</p>
        </div>

        <div>
          <h3 style={{ color: "var(--primary-color)", marginBottom: "20px" }}>Map Sekolah</h3>
